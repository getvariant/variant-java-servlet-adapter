...
5. Created [`FirefoxDisqualifier`](https://github.com/getvariant/variant-server-extensions/blob/master/server-extensions-demo/src/main/java/com/variant/server/ext/demo/FirefoxDisqualHook.java) and [`ChromeTargeter`](https://github.com/getvariant/variant-server-extensions/blob/master/server-extensions-demo/src/main/java/com/variant/server/ext/demo/FirefoxDisqualHook.java) user hooks. See [Variant Experiment Server Reference](http://www.getvariant.com/docs/0-7/experiment-server/reference/#section-4) for details on how to develop for the server extensions API. Out-of-the-box, Variant server comes with the `/ext/server-extensions-demo-0.7.1.jar` JAR file, containing class files for these hooks.
